...
roslaunch telekyb_gazebo spawn_firefly_withID.launch roboID:=2 X:=-6.9 Y:=-8.615 &

sleep 10s

roslaunch telekyb_gazebo spawn_firefly_withID.launch roboID:=3 X:=-9.06 Y:=-8.605 &
...
roslaunch hkt_experiments 3_UAV_fullyAutonomousMotion.launch &
